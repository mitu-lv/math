    ...
    return (
      <div>
        <div className="results">
            Amount of examples: <input className="setting" type="text" value={this.state.amount} onChange={this.onChangeAmount} />
            Maximum of addition: <input className="setting" type="text" value={this.state.limit} onChange={this.onChangeLimit} />
        </div>
        <ol className="equations">
        {this.state.items.map(item => (
          <li className="equation-field" key={item.id}>
              <span className="equation">{item.label}</span>
              <span className="sign">{"="}</span>
              <input className={item.correct === undefined ? '' : (item.correct === true ? 'correct' : 'incorrect')} data-id={item.id} type="text" onChange={this.onBlur} onKeyDown={this.onKeyDown} />
